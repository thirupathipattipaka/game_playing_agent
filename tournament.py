...
from game_agent import hueristic_fun_1
from game_agent import hueristic_fun_2
from game_agent import hueristic_fun_3
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                   Agent(CustomPlayer(score_fn=hueristic_fun_1, **CUSTOM_ARGS), "Student_1"),
                   Agent(CustomPlayer(score_fn=hueristic_fun_2, **CUSTOM_ARGS), "Student_2"),
                   Agent(CustomPlayer(score_fn=hueristic_fun_3, **CUSTOM_ARGS), "Student_3")]
